...
> Long-term production for the clerk remains **Docker on Synology** ([docs/deb-nas-install.md](../docs/deb-nas-install.md)). This installer is for **laptop / interim** use.
