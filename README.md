...
See **[tests/README.md](tests/README.md)** for the coverage policy (90% target; CI floor ramps up over time). Current suite: **241 tests** across Shared, Infrastructure, Api integration, and Web (bUnit).
